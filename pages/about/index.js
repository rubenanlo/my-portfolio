...
const AboutText = ({ text }) => (
  <Container
    className={{
      dimension:
        "max-h-none desktop-sm:max-h-[100vh] mr-[5px] desktop-sm:hover:-mr-[6px] mt-10 pt-10",
      overflow: "overflow-y-hidden hover:overflow-y-auto scrollbar",
    }}
  >
    <Container
      className={{
        grid: "grid-cols-1 desktop-sm:grid-cols-2 gap-10 mx-auto",
        dimension: "px-10 desktop-sm:pl-10 desktop-sm:pr-20",
        mdx: "prose prose-lg prose-slate dark:text-zinc-400 dark:prose-invert text-justify",
      }}
    >
      <MDXRemote {...text} />
    </Container>
